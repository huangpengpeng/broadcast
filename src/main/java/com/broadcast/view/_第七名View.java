...
public class _第七名View implements IBaseView{
	
	public static _第七名View _第七名View=new _第七名View();
	...
	public void createContents(Composite composite) {
		...
		group_7.setText("第七名");
		group_7.setBounds(0, 319, 886, 36);

		Label label_21 = new Label(group_7, SWT.NONE);
		label_21.setText("姓名");
		label_21.setBounds(56, 14, 31, 16);

		_姓名_宽度 = new Text(group_7, SWT.BORDER);
		_姓名_宽度.setBounds(93, 13, 40, 18);

		_姓名_高度 = new Text(group_7, SWT.BORDER);
		_姓名_高度.setBounds(150, 13, 40, 18);

		_姓名_左边 = new Text(group_7, SWT.BORDER);
		_姓名_左边.setBounds(216, 13, 40, 18);

		_姓名_上边 = new Text(group_7, SWT.BORDER);
		_姓名_上边.setBounds(276, 13, 40, 18);

		_姓名_字体大小 = new Text(group_7, SWT.BORDER);
		_姓名_字体大小.setBounds(327, 13, 40, 18);

		_姓名_颜色 = new Text(group_7, SWT.BORDER);
		_姓名_颜色.setBounds(386, 13, 40, 18);

		Label label_22 = new Label(group_7, SWT.NONE);
		label_22.setText("数量");
		label_22.setBounds(506, 14, 31, 16);

		_数量_宽度 = new Text(group_7, SWT.BORDER);
		_数量_宽度.setBounds(543, 13, 40, 18);

		_数量_高度 = new Text(group_7, SWT.BORDER);
		_数量_高度.setBounds(600, 13, 40, 18);

		_数量_左边 = new Text(group_7, SWT.BORDER);
		_数量_左边.setBounds(666, 13, 40, 18);

		_数量_上边 = new Text(group_7, SWT.BORDER);
		_数量_上边.setBounds(726, 13, 40, 18);

		_数量_字体大小 = new Text(group_7, SWT.BORDER);
		_数量_字体大小.setBounds(777, 13, 40, 18);

		_数量_颜色 = new Text(group_7, SWT.BORDER);
