...
public class _第二名View implements IBaseView {
	
	public static _第二名View _第二名View =new _第二名View();
	...
	public void createContents(Composite composite) {
		Group g_第二名 = new Group(composite, SWT.NONE);
		g_第二名.setText("第二名");
		g_第二名.setBounds(0, 139, 886, 36);

		Label label_11 = new Label(g_第二名, SWT.NONE);
		label_11.setText("姓名");
		label_11.setBounds(56, 14, 31, 16);

		_姓名_宽度 = new Text(g_第二名, SWT.BORDER);
		_姓名_宽度.setBounds(93, 13, 40, 18);

		_姓名_高度 = new Text(g_第二名, SWT.BORDER);
		_姓名_高度.setBounds(150, 13, 40, 18);

		_姓名_左边 = new Text(g_第二名, SWT.BORDER);
		_姓名_左边.setBounds(216, 13, 40, 18);

		_姓名_上边 = new Text(g_第二名, SWT.BORDER);
		_姓名_上边.setBounds(276, 13, 40, 18);

		_姓名_字体大小 = new Text(g_第二名, SWT.BORDER);
		_姓名_字体大小.setBounds(327, 13, 40, 18);

		_姓名_颜色 = new Text(g_第二名, SWT.BORDER);
		_姓名_颜色.setBounds(386, 13, 40, 18);

		Label label_12 = new Label(g_第二名, SWT.NONE);
		label_12.setText("数量");
		label_12.setBounds(506, 14, 31, 16);

		_数量_宽度 = new Text(g_第二名, SWT.BORDER);
		_数量_宽度.setBounds(543, 13, 40, 18);

		_数量_高度 = new Text(g_第二名, SWT.BORDER);
		_数量_高度.setBounds(600, 13, 40, 18);

		_数量_左边 = new Text(g_第二名, SWT.BORDER);
		_数量_左边.setBounds(666, 13, 40, 18);

		_数量_上边 = new Text(g_第二名, SWT.BORDER);
		_数量_上边.setBounds(726, 13, 40, 18);

		_数量_字体大小 = new Text(g_第二名, SWT.BORDER);
		_数量_字体大小.setBounds(777, 13, 40, 18);

		_数量_颜色 = new Text(g_第二名, SWT.BORDER);
