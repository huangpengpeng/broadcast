...
public class _第八名View implements IBaseView{
	
	public static _第八名View _第八名View=new _第八名View();
	...
	public void createContents(Composite composite) {
		...
		Group group_8 = new Group(composite, SWT.NONE);
		group_8.setText("第八名");
		group_8.setBounds(0, 354, 886, 36);

		Label label_23 = new Label(group_8, SWT.NONE);
		label_23.setText("姓名");
		label_23.setBounds(56, 14, 31, 16);

		_姓名_宽度 = new Text(group_8, SWT.BORDER);
		_姓名_宽度.setBounds(93, 13, 40, 18);

		_姓名_高度 = new Text(group_8, SWT.BORDER);
		_姓名_高度.setBounds(150, 13, 40, 18);

		_姓名_左边 = new Text(group_8, SWT.BORDER);
		_姓名_左边.setBounds(216, 13, 40, 18);

		_姓名_上边 = new Text(group_8, SWT.BORDER);
		_姓名_上边.setBounds(276, 13, 40, 18);

		_姓名_字体大小 = new Text(group_8, SWT.BORDER);
		_姓名_字体大小.setBounds(327, 13, 40, 18);

		_姓名_颜色 = new Text(group_8, SWT.BORDER);
		_姓名_颜色.setBounds(386, 13, 40, 18);

		Label label_24 = new Label(group_8, SWT.NONE);
		label_24.setText("数量");
		label_24.setBounds(506, 16, 31, 12);

		_数量_宽度 = new Text(group_8, SWT.BORDER);
		_数量_宽度.setBounds(543, 13, 40, 18);

		_数量_高度 = new Text(group_8, SWT.BORDER);
		_数量_高度.setBounds(600, 13, 40, 18);

		_数量_左边 = new Text(group_8, SWT.BORDER);
		_数量_左边.setBounds(666, 13, 40, 18);

		_数量_上边 = new Text(group_8, SWT.BORDER);
		_数量_上边.setBounds(726, 13, 40, 18);

		_数量_字体大小 = new Text(group_8, SWT.BORDER);
		_数量_字体大小.setBounds(777, 13, 40, 18);

		_数量_颜色 = new Text(group_8, SWT.BORDER);
