...
public class _第六名View implements IBaseView{

	public static _第六名View _第六名View=new _第六名View();
	...
	public void createContents(Composite composite) {
		...
		group_6.setText("第六名");
		group_6.setBounds(0, 282, 886, 36);

		Label label_19 = new Label(group_6, SWT.NONE);
		label_19.setText("姓名");
		label_19.setBounds(56, 12, 31, 16);

		_姓名_宽度 = new Text(group_6, SWT.BORDER);
		_姓名_宽度.setBounds(93, 13, 40, 18);

		_姓名_高度 = new Text(group_6, SWT.BORDER);
		_姓名_高度.setBounds(150, 13, 40, 18);

		_姓名_左边 = new Text(group_6, SWT.BORDER);
		_姓名_左边.setBounds(216, 13, 40, 18);

		_姓名_上边 = new Text(group_6, SWT.BORDER);
		_姓名_上边.setBounds(276, 13, 40, 18);

		_姓名_字体大小 = new Text(group_6, SWT.BORDER);
		_姓名_字体大小.setBounds(327, 13, 40, 18);

		_姓名_颜色 = new Text(group_6, SWT.BORDER);
		_姓名_颜色.setBounds(386, 13, 40, 18);

		Label label_20 = new Label(group_6, SWT.NONE);
		label_20.setText("数量");
		label_20.setBounds(506, 14, 31, 16);

		_数量_宽度 = new Text(group_6, SWT.BORDER);
		_数量_宽度.setBounds(543, 13, 40, 18);

		_数量_高度 = new Text(group_6, SWT.BORDER);
		_数量_高度.setBounds(600, 13, 40, 18);

		_数量_左边 = new Text(group_6, SWT.BORDER);
		_数量_左边.setBounds(666, 13, 40, 18);

		_数量_上边 = new Text(group_6, SWT.BORDER);
		_数量_上边.setBounds(726, 13, 40, 18);

		_数量_字体大小 = new Text(group_6, SWT.BORDER);
		_数量_字体大小.setBounds(777, 13, 40, 18);

		_数量_颜色 = new Text(group_6, SWT.BORDER);
